...
**Spy Agency** is a competitive deckbuilding game for 2-4 players.

## Game Setup

There are different card types: Agents, Ops (Operations), Money, Plots, Tech and Hazards. Each player will have a deck consisting of these cards.

Give player starts a deck consisting of 6 $1 cards, 1 Muscle, 1 Shadow, and 2 Red Tape cards. Return any remaining $1 cards to the box.

Place the rest of the mercenaries (Muscle Mercs and Shadow Mercs) in 2 piles (face up). These can be always be bought by the active player.

Gather the rest of the Agents, Money, Plots and Tech cards. These will create the *Market deck*, which is shuffled and placed face down on the table.

Create a Marketplace for the Market Deck. 7 different cards are offered openly for players, with any duplicates stacked and taking a single slot. 

The Op Decks are composed of the op cards, sorted by tier (I, II and III). Each deck is shuffled and placed face down on the table.

There is an Op Grid on offer for players to complete, made of 3 cards from each Op Deck. Duplicates are also stacked like in the Marketplace. This way the player should always see 9 piles of face-up Op cards.

> Red Tape cards do nothing. They're innocuous cards that sit in player decks and block out more useful cards. Players can get rid of them with the *Burn Notice* card.

Each player starts the game drawing 5 cards from their own shuffled decks, and with space for their Play and Op Areas.

Play can now begin. Keep track of who the first player was using the first-player marker &mdash; this information will be important at the end of the game. 
...
The next player to the left now starts their turn.

## Game End

The game is over at the end of the round where either of two things have happened:
1) Any of the Op Decks are empty;
2) The Market Deck is empty.

Players should then finish up the round by playing until everyone has played a same number of turns since the beginning of the game.

At the end of the game, players gather the cards in their deck, discard, play and hand areas. The player with the most stars appearing in their cards wins the game. If there's a tie, the player with the least op cards wins the game. If there's still a tie, the players rejoice in their shared victory.
