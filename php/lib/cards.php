...
function get_card_catalog(): array {
    return [
        ...
        'halo_drop' => [
            ...
            'stars' => 9,
            'cost' => 0,
            'requirements' => ['drive', 'drive', 'drive', 'drive', 'drive', 'key', 'muscle'],
            'value' => 0,
            'gems' => 0,
            'always_available' => false,
        ...
        'rooftop_showdown' => [
            ...
            'stars' => 9,
            'cost' => 0,
            'requirements' => ['muscle', 'muscle', 'muscle', 'muscle', 'drive', 'drive', 'drive'],
            'value' => 0,
            'gems' => 0,
            'always_available' => false,
            'description' => 'Requires: 💪💪💪💪🚘🚘🚘 — Reward: 9⭐',
        ...
        'megastar_machinations' => [
            ...
            'stars' => 9,
            'cost' => 0,
            'requirements' => ['disguise', 'disguise', 'disguise', 'disguise', 'muscle', 'muscle', 'key'],
            'value' => 0,
            'gems' => 0,
            'always_available' => false,
            'description' => 'Requires: 🥸🥸🥸🥸💪💪🔑 — Reward: 9⭐',
        ...
        'retinal_scan' => [
            ...
            'stars' => 4,
            'cost' => 0,
            'requirements' => ['key', 'key', 'disguise', 'disguise'],
            'value' => 5,
            'gems' => 0,
            'always_available' => false,
            'description' => 'Requires: 🔑🔑🥸🥸 — Reward: 4⭐ $5',
        ...
        'embassy_safe' => [
            ...
            'stars' => 9,
            'cost' => 0,
            'requirements' => ['key', 'key', 'key', 'disguise', 'disguise', 'disguise', 'drive'],
            'value' => 0,
            'gems' => 0,
            'always_available' => false,
            'description' => 'Requires: 🔑🔑🔑🥸🥸🥸🚘 — Reward: 9⭐',
